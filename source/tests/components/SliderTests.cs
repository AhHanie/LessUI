...
namespace LessUI
{
    ...
    public class LabeledSlider : UIElement
    {
        ...
        public string LeftAlignedLabel
        {
            ...
            set
            {
                if (_leftAlignedLabel != value)
                {
                    _leftAlignedLabel = value;
                    InvalidateSize();
                }
            }
        }
        ...
        public string RightAlignedLabel
        {
            ...
            set
            {
                if (_rightAlignedLabel != value)
                {
                    _rightAlignedLabel = value;
                    InvalidateSize();
                }
            }
        }
        ...
        public override (float width, float height) CalculateDynamicSize()
        {
            ...
            {
                return (0f, totalHeight); // Width will be set by Fill mode
            }
